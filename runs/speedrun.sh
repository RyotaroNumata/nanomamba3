...
torchrun --standalone --nproc_per_node=1 -m scripts.base_train -- --depth=12 --target-param-data-ratio=8 --device-batch-size=8 --run=$WANDB_RUN --resume-from-step=1680 --num-iterations=5000
